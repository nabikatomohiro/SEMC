...
class MultimodalSamplingSEMC : public BaseSEMCNoEx {
    /** @class MultimodalSamplingEMC
     * @brief 簡単な多峰性分布に対する交換モンテカルロ法
     */
    public:
        MultimodalSamplingSEMC(ModelOptions op, vector<vector<PriorParameter> > prior): BaseSEMCNoEx(op, prior), BaseSampling(op, prior){};
