...
class BaseSEMCNoEx : public BasePopulation, public BaseMonteCarlo{
    /** @class SEMCNoEx基底クラス */
    public:
        BaseSEMCNoEx(ModelOptions op, vector<vector<PriorParameter> > prior): BasePopulation(op, prior), BaseMonteCarlo(op, prior){
...
// void BaseSEMCNoEx::NextInverseTemperatures(int l){
//     if(l == 0){
...
void BaseSEMCNoEx::NextStepSizes(int l){
...
void BaseSEMCNoEx::UpdateStepSizes(int l, int sample_id){
...
void BaseSEMCNoEx::ExchangeMetropolis(int l){
...
void BaseSEMCNoEx::Save(string folder_name){
