...
int main(){
    ...
    op.data_num = 301;
    op.stepsize_parameter = {{{0.5, 301}, {1.2, 301}, {0.3, 301}},{{0.5, 301}, {1.2, 301}, {0.3, 301}},{{0.5, 301}, {1.2, 301}, {0.3, 301}},{{0.5, 301}, {1.2, 301}, {0.3, 301}},{{0.5, 301}, {1.2, 301}, {0.3, 301}},{{0.5, 301}, {1.2, 301}, {0.3, 301}},{{0.5, 301}, {1.2, 301}, {0.3, 301}},{{0.5, 301}, {1.2, 301}, {0.3, 301}},{{0.5, 301}, {1.2, 301}, {0.3, 301}},{{0.5, 301}, {1.2, 301}, {0.3, 301}}};
    ...
    int repeat = 10;
    vector<int> burn_in_array{750,2500,7500,25000,75000,250000,750000};
    // vector<int> L_array{10,30,100,300};
    vector<int> L_array{30,100,300};
    for(int j=0; j<L_array.size(); j++){
        // for(int i=3-j; i<6-j; i++){
        for(int i = 2 - j; i < 5 - j; i++){
