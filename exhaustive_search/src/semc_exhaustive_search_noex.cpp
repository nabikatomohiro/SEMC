...
class ExhaustiveSearchSEMC : public BaseSEMCNoEx {
    ...
    public:
        ExhaustiveSearchSEMC(ModelOptions op, vector<vector<PriorParameter> > prior, HighDimensionalData data): BaseSEMCNoEx(op, prior), data_(data), BaseSampling(op, prior){
        };
